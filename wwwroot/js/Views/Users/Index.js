...
//--------------------------------------------------------------------------------------------------------------------------------------
    ...
    var source = {
        ...
        datafields: [
            ...
            { name: 'boolValue', type: 'bool', value: 'isBanned', values: { source: boolsAdapter.records, value: 'value', name: 'label' } }
        ],
        id: 'id',
        url: url
    };
        ...
        rendertoolbar: function (toolbar) {
            ...
            $("#btnEdit").on('click', function () {
                ...
                if (selectedrowindex >= 0) {
                    ...
                    //----------------------------------------------------------------------------------
                    if (dataRecord.isBanned === true) {
                        $("#isBannedE").jqxCheckBox('check');
                    }
                    else {
                        $("#isBannedE").jqxCheckBox('uncheck');
                    }
//-----------------------------------------------------------------------------------------
        ...
        columns: [
            ...
            {
                text: 'Бан', align: 'center', cellsalign: 'center', width: 50, columntype: 'combobox',
                filtertype: 'checkedlist',
                filteritems: boolsSource, datafield: 'isBanned', displayfield: 'boolValue',
